...
def update(index):
    ...
    new_val = [kalman_roll, accel_pitch, raw_data[0]]
...
while True:
    ...
    # new_val = [kalman_roll, accel_pitch, accel_roll, raw_data[0]]

    count += 1

    if logging == 1:
        # 메시지 생성 for logging
        data.append(value.format(kalman_pitch, ",",
                                 accel_pitch, ",",
                                 accel_roll, ",",
                                 raw_data[0]))
